...
public class RecipientControllerTest {
	...
	public void shouldSaveCurrentRecipientSettings() throws Exception {
		...
		Principal principal = () -> recipient.getAccountName();

		mockMvc.perform(put("/recipients/current").principal(principal).contentType(MediaType.APPLICATION_JSON).content(json))
